    ...
    run: async(client, message, args) => {
        ...
        const embed = new MessageEmbed()
            ...
            .addField('Counts', [
                ...
                `Channels : ${guild.channels.cache.filter((ch) => ch.type === 'text' || ch.type === 'voice').size} total (Text : ${guild.channels.cache.filter((ch) => ch.type === 'text').size}, Voice : ${guild.channels.cache.filter((ch) => ch.type === "voice").size})`, `Emojis : ${guild.emojis.cache.size} (Regular : ${guild.emojis.cache.filter((e) => !e.animated).size}, Animated : ${guild.emojis.cache.filter((e) => e.animated).size})`,
            ])
