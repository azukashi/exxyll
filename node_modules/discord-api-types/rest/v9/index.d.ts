...
export declare const Routes: {
     ...
     */
    threads(parentID: Snowflake, messageID?: `${bigint}` | undefined): `/channels/${bigint}/threads` | `/channels/${bigint}/messages/${bigint}/threads`;
    /**
     * Route for:
     ...
     */
    channelThreads(channelID: Snowflake, archived?: "public" | "private" | undefined): `/channels/${bigint}/threads/active` | `/channels/${bigint}/threads/archived/public` | `/channels/${bigint}/threads/archived/private`;
    /**
     * Route for:
     * - GET `/channels/{channel.id}/users/@me/threads/archived/prviate`
     */
    channelJoinedArhivedThreads(channelID: Snowflake): `/channels/${bigint}/users/@me/threads/archived/private`;
    /**
     * Route for:
     ...
     */
    threadMembers(threadID: Snowflake, userID?: `${bigint}` | "@me" | undefined): `/channels/${bigint}/thread-members` | `/channels/${bigint}/thread-members/${bigint}` | `/channels/${bigint}/thread-members/@me`;
    /**
     * Route for:
     * - GET   `/users/@me`
     * - GET   `/users/{user.id}`
